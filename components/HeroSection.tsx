        ...
        <section className="min-h-screen bg-[#eee4ec] pt-10">
            <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center px-6">
                    ...
                    >
                        ...
                        >
                            <motion.div
                                ...
                                whileTap={{ scale: 0.95 }}
                            >
                                <SlackButton className="!bg-[#df15bc] text-white border-none cursor-pointer"
                                >
                            ...
                            <motion.div
                                ...
                                whileTap={{ scale: 0.95 }}
                            >
                                <SlackButton className="cursor-pointer">
                                    <motion.a href="#courses">
                                        View Courses
                                    </motion.a>
                                </SlackButton>
                    ...
                    >
                        {/* The image use here is generated by Gemini so to generate your own image you can use Gemini.... screenshot the image paste it to gemini and tell gemini to generate same image but with the content you want the image to use e.g instead of debugged! and happy coding you can replace it with the one you want. */}
                        <motion.img
                            src={potteryKid.src}
